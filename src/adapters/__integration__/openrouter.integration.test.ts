...
const config: AppConfig = {
  ...
  models: { 'free-model': { channel: 'openrouter-test', model: 'google/gemini-2.0-flash-lite-001' } },
}

describe.skipIf(!process.env.OPENROUTER_API_KEY)('OpenRouter adapter (openai-compatible) — integration', () => {
